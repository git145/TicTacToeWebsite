 ...
 <html lang = "en">
     ...
     <!--
         File: tictactoe_hofgwon.php
         Module: COMP519
         Author: Richard Kneale
         Student ID: 200790336
         Date created: 1st January 2016
         Description: Displays the three users who have won the most games
       -->
     ...
     <head> 
		 ...
		 <?php
			 ...
			 else
			 {
				 ...
				 $sql = "SELECT * FROM ".$table." ORDER BY gWon DESC";
				 $result = $db->query($sql);
     ...
     <body>
         <?php
			 ...
			 print(  '<div id = "resultsSpace">
						 <div class = "textCenter boldText largeText" id = "hallOfFameTitle">Top 3 Players in Games Won</div><br/>
						 
						 <table id = "hallOfFameTable">
							 <tr>
								 <td class = "textLeft boldText">'.$user1.':</td>
								 <td class = "textCenter" id = "numberOfGames">'.$gWon1.'</td>
							 </tr>
             
							 <tr>
								 <td class = "textLeft boldText">'.$user2.':</td>
								 <td class = "textCenter" id = "numberOfGames">'.$gWon2.'</td>
							 </tr>
             
							 <tr>
								 <td class = "textLeft boldText">'.$user3.':</td>
								 <td class = "textCenter" id = "numberOfGames">'.$gWon3.'</td>
							 </tr>
						 </table><br/>
						 '.getHOFButtons().'
					 </div>'
